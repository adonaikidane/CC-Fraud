...
Overview
This project builds a fraud detection pipeline on a dataset of ~42,800 transactions (99% non-fraudulent, 1% fraudulent). It covers end-to-end data preprocessing, feature engineering, exploratory data analysis, and model training.
Dataset
